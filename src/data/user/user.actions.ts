import { getUserData, setIsLoggedInData, setUsernameData, setEmailData, setRoleData, setHasSeenTutorialData } from '../dataApi';
...
export const setRole = (role?: string) => async (dispatch: React.Dispatch<any>) => {
